...
gamma_k = function(k){
  my_vector_1 = matrix(data = c(cos(2*k*pi/2.7),sin(2*k*pi/3.5),cos(2*k*pi/5),sin(2*k*pi/5),sign(sin(k-2.5))), nrow = 5, ncol = 1)
  my_vector_2 = matrix(data = c(0.8*sign(sin(k-2.5)),0.4*sign(sin(k-2.5)),0.2*sign(sin(k-2.5)),0.5*sign(cos(k-2.5)),0.5*sign(cos(k-2.5))), nrow = 5, ncol = 1)
  my_vector = rbind(my_vector_1,my_vector_2)
}
...
file_name_x = 'D:/研究生文件/科研任务/functional_data/sim_data/s10/all_data_0309(10)_'
file_name_y = 'D:/研究生文件/科研任务/functional_data/sim_data/s10/y_label_0309(10)_'

file_name_x_t = 'D:/研究生文件/科研任务/functional_data/sim_data/s10/all_data_test_0309(10)_'
file_name_y_t = 'D:/研究生文件/科研任务/functional_data/sim_data/s10/y_label_test_0309(10)_'
...
for (iter in 1:100){
  ...
  for (i in 1:n) {
    ...
    my_s[i,6] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s[i,7] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s[i,8] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s[i,9] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s[i,10] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
  }
  ...
  for (i in 1:n) {
    ...
    my_s_test[i,6] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s_test[i,7] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s_test[i,8] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s_test[i,9] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
    my_s_test[i,10] = sample(x = c(rnorm(1,-1,0.25),rnorm(1,1,0.25)), size = 1)
  }
  ...
  for (i in 1:n) {
    score = c(0,0,0)
    for (k in 1:5) {
      score[k] = cos(2*k*pi/2.7) * my_xi_test[i,1] + sqrt(2)*sin(2*k*pi/3.5) * my_xi_test[i,2] +((my_s_test[i,]) %*% (gamma_k(k)))[1,1]
    }
